...
class ArgsNameTest {
    ...
    @Test
    void whenNotContainKeyThenExceptionThrown() {
        assertThatThrownBy(() -> ArgsName.of(new String[]{"-=535673567", "-=56738ghdfgt="}))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageMatching("^.+")
                .hasMessageContaining("Error: This argument '-=535673567' does not contain a key");
    }
    ...
    @Test
    void whenNotContainValueThenExceptionThrown() {
        assertThatThrownBy(() -> ArgsName.of(new String[]{"-Xux=", "-oneTwo="}))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageMatching("^.+")
                .hasMessageContaining("Error: This argument '-Xux=' does not contain a value");
    }
    ...
    @Test
    void whenThereStartWithNoSignThenExceptionThrown() {
        assertThatThrownBy(() -> ArgsName.of(new String[]{"Xmx=512", "request?msgHello"}))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageMatching("^.+")
    ...
    @Test
    void whenThereNoEqualSignThenException() {
        assertThatThrownBy(() -> ArgsName.of(new String[]{"-XmTrue12", "-request?msgHello", "-request?msgHello"}))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageMatching("^.+")
                .hasMessageContaining("Error: This argument '-XmTrue12' does not contain an equal sign");
    }
